"""CLI command group: logatory windows — analyze Windows Event Log exports."""
...
from logatory.adapters.windows import WindowsEventLogAdapter
...
def windows_tail(
    ...
    print_tail_header(
        [
            f"  Following : Windows log — {log}{f' ({provider})' if provider else ''}",
